...
export default function TextScanScreen() {
    ...
    const handleAnalyzeMood = async () => {
        if (journalText.trim() === '') {
            Alert.alert('Input Required', 'Please pour your thoughts into the text area before analyzing!');
            return;
        }
        Keyboard.dismiss();
        setIsAnalyzing(true);
        ...
        try {
            ...
            try {
                ...
                console.log('📤 [TextScanScreen] Sending to AI:', API_ENDPOINTS.AI.TEXT_EMOTION, requestPayload);
                ...
                console.log('📥 [TextScanScreen] AI Response Status:', aiResponse.status);
                ...
                console.log('✅ [TextScanScreen] AI Text Result:', aiData);
            ...
            console.error('TextScan analysis error:', err.message);
                ...
                <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
                    <View style={[styles.container, { backgroundColor: bgColor }]}>
                        ...
                        <View style={[styles.headerContainer, { backgroundColor: bgColor }]}>
                            ...
                            <Text style={[styles.headerTitle, { color: textColor }]}>Text Scan</Text>
